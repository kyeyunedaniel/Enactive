...
function AboutData() {
  ...
  <div class="mx-auto mt-20 mb-16 block px-6 text-center">
    <h2 class="mx-auto text-4xl font-bold md:text-5xl">The Future is Here.</h2>
    <div class="mx-auto mt-6 mb-auto block w-full text-xl font-normal leading-9 text-gray-700 md:w-3/4 xl:w-3/4">
      <p class="text-lg">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolorem provident repellat cupiditate blanditiis! Sit temporibus doloremque molestias, aut necessitatibus quisquam non deleniti debitis aperiam ullam! Repudiandae, debitis iure libero reiciendis ducimus temporibus!</p>
    </div>
    <div class="mt-8 text-center">
      <a class="mx-2 mb-2 inline-block rounded bg-blue-500 px-6 py-2 text-xl font-medium text-white shadow md:mx-4 md:mt-2 md:text-lg hover:scale-105 hover:shadow-md" href="#" target="_blank">Get Started</a>
      <a class="mx-2 mb-2 inline-block rounded bg-gray-900 px-6 py-2 text-xl font-medium text-white shadow md:mx-4 md:mt-2 md:text-lg hover:scale-105 hover:shadow-md" href="#">Book a Demo</a>
    </div>
  </div>
