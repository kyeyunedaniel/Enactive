...
const Tab = ({ children, isActive, icon: Icon, onClick }) => (
    <button
        onClick={onClick}
...
const VerificationBadge = ({ verified, onVerify, loading = false }) => (
...
export default function Settings({ auth }) {
    ...
    return (
        ...
        >
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-end gap-3">
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 text-sm font-medium text-white bg-green-600 rounded-lg hover:bg-green-700 disabled:opacity-75"
                                >
            ...
            <button 
                className="fixed bottom-6 right-6 bg-green-600 text-white w-12 h-12 rounded-full flex items-center justify-center shadow-lg hover:bg-green-700 transition-colors z-40"
                aria-label="Help"
            >
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-1">
                                    ...
                                    <VerificationBadge 
                                        ...
                                        loading={isSendingCode && verificationType === 'email'}
                                    />
                                </div>
                                <input
                                    id="email"
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-1">
                                    ...
                                    <VerificationBadge 
                                        ...
                                        loading={isSendingCode && verificationType === 'phone'}
                                    />
                                </div>
                                <input
                                    id="phone"
                                ...
                                <div className="flex flex-wrap gap-4 mt-4">
                                    <div className="flex items-center">
                                        <input
                                            ...
                                            onChange={() => setEmailLimit('unlimited')}
                                            className="h-4 w-4 border-gray-300 text-green-600 focus:ring-green-500"
                                        />
                                        <label htmlFor="limit-unlimited" className="ml-2 block text-sm text-gray-700">
                                            Unlimited
                                        </label>
                                    </div>
                                    <div className="flex items-center">
                                        <input
                                            ...
                                            onChange={() => setEmailLimit('5')}
                                            className="h-4 w-4 border-gray-300 text-green-600 focus:ring-green-500"
                                        />
                                        <label htmlFor="limit-5" className="ml-2 block text-sm text-gray-700">
                                            5 per day
                                        </label>
                                    </div>
                                    <div className="flex items-center">
                                        <input
                                            ...
                                            onChange={() => setEmailLimit('10')}
                                            className="h-4 w-4 border-gray-300 text-green-600 focus:ring-green-500"
                                        />
                                        <label htmlFor="limit-10" className="ml-2 block text-sm text-gray-700">
                                            10 per day
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="p-4 bg-gray-50 rounded-lg">
                                ...
                                <div className="text-sm text-gray-600">
                                    <p>Last login: Today at {new Date().toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}</p>
                                    <p>Device: {navigator.userAgent.split(') ')[0].split('(')[1]}</p>
                                    <p>Location: (Approximate location based on IP)</p>
                                </div>
                            </div>
